...
public class modalServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameter("feladat").equals("modal")) {
                StoredProcedureQuery spq = em.createStoredProcedureQuery("getAllEtterem");
                StoredProcedureQuery spq2 = em.createStoredProcedureQuery("GetIdForModal");
                ...
                for (Object[] etterem : ettermek) {
                  ...
                  int id = Integer.parseInt(request.getParameter("id")); // BEFEJEZÉSRE VÁR! 
                  em.getTransaction().begin();
                  Etterem e = em.find(Etterem.class, id);
